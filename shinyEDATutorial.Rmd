...
The last object we have in the `RData` file is the `pathways` object. This is a list of pathways from the Reactome database that the 836 genes that we have selected are overrepresented in. 
...
There are lots of directions that we can modify the code with. We can condition plots on outcomes. We can condition the plots on demographics.
